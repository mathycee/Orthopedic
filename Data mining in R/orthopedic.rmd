...
library(rpart)
attach(merghosp)
hospfit<-rpart(SALES~Factor1+Factor2+Factor3, data=merghosp)
...
plot(fit2, uniform=TRUE, main="Regression Tree")
text(fit2,cex=0.6)

factor(pred)[1:10]
as.numeric(factor(pred)[1:10])
table(as.numeric(factor(pred)))
```
